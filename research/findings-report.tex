...
\begin{itemize}
  ...
  \item \texttt{artifacts/evidence/xposts.md} — compiled \account\ post archive with engagement metrics (2024--2026)
...
The Sentinel Network article reports \textbf{1{,}645 posts} as of their investigation. The 583-tweet figure in the local \texttt{/tmbspaceships} repo was one export corpus excluding replies and retweets; the TwiCopy mirror captured a later subset. The engagement figures in \texttt{artifacts/evidence/xposts.md} extend the picture: the February 24, 2026 ``Modern spacecraft'' post reached 104{,}900 views; the final standalone post reached 65{,}700 views.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../artifacts/evidence/schematic.png}
